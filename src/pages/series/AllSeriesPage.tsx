...
import { setSelectedSeriesCategory } from "../../redux/features/favourite/favouriteSlice";
            ...
            {categoryData?.data
              ...
              .map((item: any, index: number) => (
                <button
                  ...
                  onClick={() =>
                    dispatch(setSelectedSeriesCategory(item.category_id))
                  }
                  type="button"
                  onKeyDown={(e) => {
                    if (e.key === "Enter") {
